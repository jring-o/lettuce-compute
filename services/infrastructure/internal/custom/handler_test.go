...
func (m *mockWURepo) UpdateHeartbeat(ctx context.Context, id types.ID) error { return nil }
...
func (m *mockWURepo) FlushReservations(ctx context.Context, recs []workunit.FlushReservation) ([]types.ID, error) {
	return nil, nil
}
