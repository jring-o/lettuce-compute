...
func (r *mockWorkUnitRepo) ReleaseStaleHeldCopies(context.Context, types.ID, []types.ID, time.Time) ([]workunit.ReleasedCopy, error) {
	return nil, nil
}
...
func (r *mockWorkUnitRepo) CloseCopyByVolunteer(context.Context, types.ID, types.ID, string, *types.ID, string) (workunit.ClosedCopy, error) {
