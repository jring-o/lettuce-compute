...
func (m *mockWURepo) UpdateHeartbeat(_ context.Context, _ types.ID) error { return nil }
...
func (m *mockWURepo) FlushReservations(_ context.Context, _ []workunit.FlushReservation) ([]types.ID, error) {
	return nil, nil
}
