...
func (x *RegisterVolunteerRequest) GetPowChallengeId() string {
	if x != nil {
		return x.PowChallengeId
	}
	return ""
}

func (x *RegisterVolunteerRequest) GetPowNonce() uint64 {
	if x != nil {
		return x.PowNonce
	}
	return 0
...
func (x *GetRegistrationChallengeRequest) Reset() {
	*x = GetRegistrationChallengeRequest{}
	mi := &file_proto_lettuce_v1_volunteer_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetRegistrationChallengeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRegistrationChallengeRequest) ProtoMessage() {}

func (x *GetRegistrationChallengeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_lettuce_v1_volunteer_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRegistrationChallengeRequest.ProtoReflect.Descriptor instead.
func (*GetRegistrationChallengeRequest) Descriptor() ([]byte, []int) {
	return file_proto_lettuce_v1_volunteer_proto_rawDescGZIP(), []int{4}
}

type GetRegistrationChallengeResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ChallengeId    string                 `protobuf:"bytes,1,opt,name=challenge_id,json=challengeId,proto3" json:"challenge_id,omitempty"`           // redeem via RegisterVolunteerRequest.pow_challenge_id
	Challenge      []byte                 `protobuf:"bytes,2,opt,name=challenge,proto3" json:"challenge,omitempty"`                                  // 32 random bytes, part of the solution-hash preimage
	DifficultyBits uint32                 `protobuf:"varint,3,opt,name=difficulty_bits,json=difficultyBits,proto3" json:"difficulty_bits,omitempty"` // required leading zero bits of the solution digest
	ExpiresAtUnix  int64                  `protobuf:"varint,4,opt,name=expires_at_unix,json=expiresAtUnix,proto3" json:"expires_at_unix,omitempty"`  // challenge validity deadline (Unix seconds, UTC)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *GetRegistrationChallengeResponse) Reset() {
	*x = GetRegistrationChallengeResponse{}
	mi := &file_proto_lettuce_v1_volunteer_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetRegistrationChallengeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRegistrationChallengeResponse) ProtoMessage() {}

func (x *GetRegistrationChallengeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_lettuce_v1_volunteer_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRegistrationChallengeResponse.ProtoReflect.Descriptor instead.
func (*GetRegistrationChallengeResponse) Descriptor() ([]byte, []int) {
	return file_proto_lettuce_v1_volunteer_proto_rawDescGZIP(), []int{5}
}

func (x *GetRegistrationChallengeResponse) GetChallengeId() string {
	if x != nil {
...
func (x *GetRegistrationChallengeResponse) GetChallenge() []byte {
	if x != nil {
		return x.Challenge
	}
	return nil
...
func (x *GetRegistrationChallengeResponse) GetDifficultyBits() uint32 {
	if x != nil {
		return x.DifficultyBits
	}
	return 0
}

func (x *GetRegistrationChallengeResponse) GetExpiresAtUnix() int64 {
	if x != nil {
...
// LeafResourceRequirements is what a leaf demands of a MACHINE, as distinct from
// ExecutionSpec's per-unit sandbox limits. Dispatch matches these against the
// volunteer's advertised resource_limits (min_disk_mb against max_disk_gb*1024,
// min_cpu_cores against max_cpu_cores), so a leaf whose requirements exceed them
// is never sent to that volunteer. Sending them lets the client answer "will this
// machine ever run this leaf?" honestly instead of reporting eligible and idling
// (TB-15).
//
// Note min_disk_mb is NOT ExecutionSpec.max_disk_mb: that is the sandbox's disk
// ceiling for one unit, this is the machine budget dispatch gates on, and nothing
// keeps the two in step. Gate on this one.
type LeafResourceRequirements struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	MinDiskMb   int64                  `protobuf:"varint,1,opt,name=min_disk_mb,json=minDiskMb,proto3" json:"min_disk_mb,omitempty"`
	MinCpuCores int32                  `protobuf:"varint,2,opt,name=min_cpu_cores,json=minCpuCores,proto3" json:"min_cpu_cores,omitempty"`
	// The three GPU dimensions dispatch also matches on (TB-21). Sent for the same
	// reason as the two above: without them the client reports a GPU leaf eligible
	// for any machine that has a GPU at all, whatever its size or make, and the
	// volunteer idles with every local check passing.
	//
	// min_gpu_vram_mb is NOT compared against the card's capacity — dispatch
	// compares it against VRAM * the volunteer's max_gpu_vram_pct / 100, the share
	// they have allowed. A client checking it against raw card size will report
	// machines eligible that the head refuses, which is the bug this field exists
	// to end. gpu_type is the required vendor ("NVIDIA"/"AMD"/"WEBGPU"), empty or
	// "ANY" meaning no constraint; gpu_compute_capability is an exact-match string
	// (e.g. "8.6"), empty meaning no constraint.
...
func (x *LeafResourceRequirements) Reset() {
	*x = LeafResourceRequirements{}
	mi := &file_proto_lettuce_v1_volunteer_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LeafResourceRequirements) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LeafResourceRequirements) ProtoMessage() {}

func (x *LeafResourceRequirements) ProtoReflect() protoreflect.Message {
	mi := &file_proto_lettuce_v1_volunteer_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LeafResourceRequirements.ProtoReflect.Descriptor instead.
func (*LeafResourceRequirements) Descriptor() ([]byte, []int) {
	return file_proto_lettuce_v1_volunteer_proto_rawDescGZIP(), []int{21}
}

func (x *LeafResourceRequirements) GetMinDiskMb() int64 {
	if x != nil {
		return x.MinDiskMb
	}
	return 0
...
func (x *LeafResourceRequirements) GetMinCpuCores() int32 {
	if x != nil {
...
func (x *LeafResourceRequirements) GetMinGpuVramMb() int32 {
	if x != nil {
		return x.MinGpuVramMb
	}
	return 0
}

func (x *LeafResourceRequirements) GetGpuType() string {
	if x != nil {
		return x.GpuType
	}
	return ""
...
func (x *LeafResourceRequirements) GetGpuComputeCapability() string {
	if x != nil {
...
type LeafInfo struct {
	...
	// Machine requirements dispatch gates on. Absent (nil) from a pre-TB-15 head,
	// which the client must read as "unknown", not as "no requirement".
	ResourceRequirements *LeafResourceRequirements `protobuf:"bytes,13,opt,name=resource_requirements,json=resourceRequirements,proto3" json:"resource_requirements,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *LeafInfo) GetResourceRequirements() *LeafResourceRequirements {
	if x != nil {
...
const file_proto_lettuce_v1_volunteer_proto_rawDesc = "" +
	...
	"\x0fdifficulty_bits\x18\x03 \x01(\rR\x0edifficultyBits\x12&\n" +
	"\x0fexpires_at_unix\x18\x04 \x01(\x03R\rexpiresAtUnix\"\xe7\x02\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xad\x04\n" +
	"\bLeafInfo\x12\x0e\n" +
