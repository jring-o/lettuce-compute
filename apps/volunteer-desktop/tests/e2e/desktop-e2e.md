...
| 2.3 | Resources: set CPU cores below the machine's maximum and memory to about half of it. Note the values. | Sliders accept the values; the memory slider's maximum matches the machine's physical memory. |
